...
Original file is located at
    https://colab.research.google.com/drive/1xi-0ag0nacSg5gnRMiwZkoeOor0uRMLh
"""
...
with gr.Blocks(
    ...
    with gr.Row():
        with gr.Column(scale=3):
            chatbot = gr.Chatbot(
                label="‍:speech_balloon: Query Conversion",
                height=450,
            ...
            with gr.Row():
                query_input = gr.Textbox(
                    label="‍:memo: Natural Language Request",
        ...
        with gr.Column(scale=1):
            ...
            clear_btn = gr.Button("‍:wastebasket: Clear History", variant="stop", size="sm")
            clear_btn.click(clear_chat, outputs=[chatbot])

            gr.Markdown("---")
            gr.Markdown("### ‍:inbox_tray: Export")

            pdf_btn = gr.Button("‍:page_facing_up: Download PDF", size="sm", variant="primary")
            txt_btn = gr.Button("‍:clipboard: Download TXT", size="sm", variant="primary")
            ...
            gr.Markdown("---")
            gr.Markdown("### ‍:iphone: Share")

            whatsapp_btn = gr.Button("‍:speech_balloon: WhatsApp", size="sm", variant="secondary")
            facebook_btn = gr.Button("‍:+1: Facebook", size="sm", variant="secondary")
...
print("\n‍:rocket: SQL Query Generator Ready!\n")
